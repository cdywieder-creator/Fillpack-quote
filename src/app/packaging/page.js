...
export default function PackagingPage() {
  ...
  return (
    <div>
      ...
      <form onSubmit={save} className="mt-4 grid grid-cols-2 gap-3 rounded-lg border border-gray-200 bg-white p-4 sm:grid-cols-7">
        ...
        <input placeholder='Description * (e.g. "16 oz PET Boston Round")' value={form.description}
          ...
          className="col-span-2 rounded border border-gray-300 px-3 py-2 text-sm" required />
